...
// CLUG PAGE
let clugCategorySlideshow = ".clug-category-slideshow"

if (clugCategorySlideshow) {
  $(clugCategorySlideshow).slick({
    infinite: true,
    dots: false,
    arrows: true,
    slidesToShow: 3.5,
